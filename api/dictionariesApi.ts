...
export enum DictionariesApiApiKeys {
    APIKeyHeader,
}
...
export class DictionariesApi {
    ...
    public setApiKey(key: DictionariesApiApiKeys, value: string) {
        (this.authentications as any)[DictionariesApiApiKeys[key]].apiKey = value;
    }
